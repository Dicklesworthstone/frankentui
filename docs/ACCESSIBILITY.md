...
| `ftui-extras::FilePicker` | List + ListItem | filtered window, file kind/size, selection, reusable manual-render semantics |
...
- Continue auditing Tree plus tab-panel and pane-workspace hierarchy
