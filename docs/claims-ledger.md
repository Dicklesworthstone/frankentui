...
| C21 | Input "history"; Textarea "syntax hooks"; Progress "indeterminate"; JsonView "collapse/expand"; Sparkline "min/max markers" | README.md :: Input "history"; Textarea "syntax hooks"; Progress "indeterminate"; JsonView "collapse/expand"; Sparkline "min/max markers" | api | CODE | bd-g00-root-epic-ewths.23.1 | test:ftui-widgets::input::history_tests::history_records_on_enter; test:ftui-widgets::progress::indeterminate_tests::progress_indeterminate_phase0_40x1; test:ftui-widgets::sparkline::marker_tests::min_marker_placed_at_first_min | proven | 2026-09-19 |
...
| C24 | VFX list credited to ftui-extras | README.md :: VFX list credited to ftui-extras | api | DOC | bd-g00-root-epic-ewths.5.5 | test:ftui-extras::visual_fx::tests::render_plasma_frame_deterministic | retracted | 2026-09-19 |
