...
| C11 | `Cmd::perform(future, mapper)` | README.md :: `Cmd::perform(future, mapper)` | api | DOC | bd-g00-root-epic-ewths.5.5 | bead:bd-g00-root-epic-ewths.5.5 | pending-doc | - |
| C12 | `Cmd::SetClipboard/GetClipboard` | README.md :: `Cmd::SetClipboard/GetClipboard` | api | CODE | bd-g00-root-epic-ewths.21 | bead:bd-g00-root-epic-ewths.21 | pending-code | - |
| C13 | `tick_every`, `file_watcher` | README.md :: `tick_every`, `file_watcher` | api | CODE | bd-g00-root-epic-ewths.22 | bead:bd-g00-root-epic-ewths.22 | pending-code | - |
...
| C16 | `field_lens!` macro | README.md :: `field_lens!` macro | api | DOC+quarantine | bd-g00-root-epic-ewths.5.5 | bead:bd-g00-root-epic-ewths.5.5 | pending-doc | - |
...
| C19 | Degradation ladder Full, SimpleBorders, NoColors, TextOnly | README.md :: Degradation ladder Full, SimpleBorders, NoColors, TextOnly | api | DOC | bd-g00-root-epic-ewths.5.5 | bead:bd-g00-root-epic-ewths.5.5 | pending-doc | - |
...
| C21 | Input "history"; Textarea "syntax hooks"; Progress "indeterminate"; JsonView "collapse/expand"; Sparkline "min/max markers" | README.md :: Input "history"; Textarea "syntax hooks"; Progress "indeterminate"; JsonView "collapse/expand"; Sparkline "min/max markers" | api | CODE | bd-g00-root-epic-ewths.23.1 | bead:bd-g00-root-epic-ewths.23.1 | pending-code | - |
| C22 | "Plus" widget names `Cached`, `DragHandle`, `Inspector`, `NotificationQueue`, `ValidationError` | README.md :: "Plus" widget names `Cached`, `DragHandle`, `Inspector`, `NotificationQueue`, `ValidationError` | api | DOC | bd-g00-root-epic-ewths.5.5 | bead:bd-g00-root-epic-ewths.5.5 | pending-doc | - |
...
| C30 | "Hybrid" inline strategy is default with runtime DECSTBM-reliability fallback | README.md :: "Hybrid" inline strategy is default with runtime DECSTBM-reliability fallback | api | CODE | bd-g00-root-epic-ewths.4.3 | bead:bd-g00-root-epic-ewths.4.3 | pending-code | - |
...
| V14 | Multi-stage conformal monitors | README.md :: Multi-stage conformal monitors | status | CODE | bd-g00-root-epic-ewths.15 | bead:bd-g00-root-epic-ewths.15 | pending-code | - |
...
| V59 | Cost models (cache / M-G-1 / batching) | README.md :: Cost models (cache / M-G-1 / batching) | status | CODE | bd-g00-root-epic-ewths.11 | bead:bd-g00-root-epic-ewths.11 | pending-code | - |
...
| S35 | Bidirectional Lenses production status | README.md:2739 :: Bidirectional Lenses | status | DOC | bd-g00-root-epic-ewths.5.5 | bead:bd-g00-root-epic-ewths.5.5 | pending-doc | - |
